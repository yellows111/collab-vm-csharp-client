...
namespace CollabClient
{
    public partial class Form1 : Form
    {
		private static DialogResult ShowConnectDialog(ref string ip, ref string node, ref string username)
		{
            ...
            cb.Items.AddRange(new[] {"Computernewb VM1","Computernewb VM2","Computernewb VM3","Computernewb VM4","Computernewb VM5","DarkOK Vista","DarkOK X-Ray Man","FSP Haiku","SandVM VM1"});
            cb.SelectedIndexChanged += (s, e) => { switch (cb.SelectedIndex+1) {
					...
					case 8: textBox.Text = "home.funshitposting.xyz:6004"; textBox2.Text = "haiku"; break;
					case 9: textBox.Text = "sandvm.malakas.ml:6004"; textBox2.Text = "vm1"; break;
                }
            };
